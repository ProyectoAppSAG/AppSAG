<%-- 
    Document   : newjsp
    Created on : 23/07/2014, 11:39:29 AM
    Author     : Usuario
--%>
<%@page import="com.Beans.BeanOpcionMenu"%>
<%@page import="com.Beans.BeanUsuario"%>
<%@page import="com.DAO.DAOUsuario"%>
<%
    BeanUsuario beanUsuario=(BeanUsuario)session.getAttribute("sesUsuario");
%>
				...
				<li class="sidebar-toggler-wrapper">
					...
					<a href="home.jsp">
						...
						<span class="arrow open">
                                ...
                                <%
                                    if(beanUsuario!=null &&  beanUsuario instanceof BeanUsuario){
                                        for(BeanOpcionMenu bom:beanUsuario.getOpcionesMenu()){%>
                                            <li>
                                                    <a href="javascript:;">
                                                            <i class="fa <%=bom.getIcono()%>"></i>
                                                            <span class="title"><%=bom.getNombre()%></span>
                                                            <span class="arrow">
                                                            </span>
                                                            <% if(bom.getSubMenus()!=null && !bom.getSubMenus().isEmpty()){%>
                                                                <ul class="sub-menu">
                                                                        <%for(BeanOpcionMenu subBom:bom.getSubMenus()){%>
                                                                            <li>
                                                                                    <a href="<%=subBom.getLink()%>">
                                                                                        <i class="fa <%=subBom.getIcono()%>"></i>
                                                                                             <%=subBom.getNombre()%>
                                                                                    </a>
                                                                            </li>
                                                                        <%}%>
...
<script src="assets/plugins/gritter/js/jquery.gritter.js" type="text/javascript"></script>IMPORTANT! fullcalendar depends on jquery-ui-1.10.3.custom.min.js for drag & drop support
